...
![](Images/side_down.jpg)

# 2. Các màn hình trên thiết bị

## 2.1. Màn hình chơi game

### 2.1.1. Màn hình khởi động

Màn hình hiển thị đầu tiên khi khởi động thiết bị, thể hiện ngắn gọn thông tin về dự án, tác giả.
...
![](Images/front_play.jpg)

### 2.1.3. Màn hình shotgun
Hiển thị khẩu shotgun và các button chọn người chơi để shot.

![](Images/front_shotgun.jpg)
